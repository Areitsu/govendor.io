...
<body>
        ...
        <header class="py-sm-3 pt-3 pb-2" id="home">
            <div class="container">
                ...
                <div class="top-w3pvt d-flex">
                    <div id="logo">
                        <h1> <a href="index.html"><span class="log-w3pvt">G</span>oVendor</a> 
                    </div>
        ...
        <div class="banner-wthree-info container">
            <div class="row">
                <div class="col-lg-5 banner-left-info">
                    <h3>Find Vendors <span>Near You</span></h3>
                    <a href="shop.html" class="btn shop">Search</a>
                </div>

                <div class="col-lg-7 banner-img">
                    <img src="images/intro_03-2000.jpg"   alt="part image" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row grids-wthree-info text-center">
                <div class="col-lg-4 ab-content">
                    <div class="ab-info-con">
                        <h4>Sign up and become a Vendor</h4>
                        <p>When you sign up with GoVendor. You have access to posting your goods. </p>
                    </div>
                </div>
                <div class="col-lg-4 ab-content">
                    <div class="ab-info-con">
                        <h4>Search for goods</h4>
                        <p>Everyone who signs up with GoVendor has access to find goods they are looking for with our simple search menu.</p>
                    </div>
                </div>
                <div class="col-lg-4 ab-content">
                    <div class="ab-info-con">
    ...
    <section class="banner-bottom py-5">
        <div class="container py-md-5">
            ...
            <h3 class="title-wthree mb-lg-5 mb-4 text-center"> Meet local Vendors </h3>
            <div class="row text-center">


                <div class="col-md-4 content-gd-wthree">
                    <img src="images/Vendor2.jpg" class="img-fluid" alt="" />
                </div>
                <div class="col-md-4 content-gd-wthree ab-content py-lg-5 my-lg-5">
                    <h4>Want to search?</h4>
                    <p>Supporting our local vendors is what we are all about.</p>
                    <a href="shop.html" class="btn shop mt-3">Search Vendors</a>

                </div>
                <div class="col-md-4 content-gd-wthree">
                    <img src="images/vendor3.jpg" class="img-fluid" alt="" />
                </div>
            </div>
    ...
    <div class="cpy-right text-center py-3">
        <p>© 2022 GoVendor. All rights reserved 
        </p>
